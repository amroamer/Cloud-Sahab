  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-6 max-w-[1200px] mx-auto space-y-6">
        <Link href="/data-products">
          <Button variant="ghost" size="sm" className="gap-1.5" data-testid="button-back-storefront">
          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {relatedProducts.map((rp) => (
                <Link key={rp.id} href={`/data-products/${rp.id}`}>
                  <Card className="p-4 hover-elevate cursor-pointer" data-testid={`card-related-${rp.id}`}>
                    ...
                    <div className="flex items-center gap-1 mb-2">
                      ...
                      <span className="text-[10px] text-muted-foreground">({rp.reviewCount})</span>
                    </div>
                    <div className="flex items-center justify-between">
                      {rp.isFree ? (
                        ...
                        <span className="text-sm font-bold">
                          {rp.price.toLocaleString()} {language === "ar" ? "ر.س" : "SAR"}
                        </span>
                      )}
                    </div>
                  </Card>
